    ...
    <div>
        ...
        <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            <div className="md:5/12 lg:w-5/12">
              <img
                src="https://th.bing.com/th/id/R.3e9b24cc648f1b17722aa733be4ec950?rik=WlFb827KXIEd5w&pid=ImgRaw&r=0g"
                alt="image"
                loading="lazy"
                width=""
                height=""
      ...
      <div className="container my-24 px-6 mx-auto">
        <section className="mb-32 text-gray-800 text-center">
          ...
          <div className="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">Azzam faraj</h5>
            ...
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">Dua'a Nawwas</h5>
                  <p className="mb-6">BackEnd Developer</p>
                  <ul className="list-inside flex mx-auto justify-center">
                    <Link to="#!" className="px-2">
                      <svg
            ...
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">ibrahim alkhamaiseh</h5>
                  <p className="mb-6">BackEnd Developer</p>
                  <ul className="list-inside flex mx-auto justify-center">
                    <Link to="#!" className="px-2">
                      <svg
          ...
          <div className="grid gap-x-6 lg:gap-x-12 md:grid-cols-3 team4">
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                <div className="flex justify-center">
                  <div className="flex justify-center" style={{ marginTop: "-75px" }}>
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">MOHAMMAD KHALIL</h5>
            ...
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">Noor Shatnawi</h5>
                  <p className="mb-6">Frontend Developer</p>
                  <ul className="list-inside flex mx-auto justify-center">
                    <Link to="#!" className="px-2">
                      <svg
            ...
            <div className="mb-24 md:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h5 className="text-lg font-bold mb-4">Emad Alhashash</h5>
                  <p className="mb-6">Frontend Developer</p>
                  <ul className="list-inside flex mx-auto justify-center">
                    <Link to="#!" className="px-2">
                      <svg
