...
function ComponentContact() {
    ...
    const createContact = async (e) => {
        ...
        await axios.post('/api/contact', formData).then(({ data }) => {
            if (data.status === 200) {
                console.log(data);
                setName('')
                setEmail('')
                            ...
                            >
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
                                    ...
                                    <div className="mb-12 lg:mb-0 text-center mx-auto">
                                        ...
                                        <h6 className="font-medium">Zarqa, 94126</h6>
                                    </div>
                                    ...
                                    <div className="mb-6 md:mb-0 text-center mx-auto">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="headset" className="w-8 h-8 text-blue-600 mb-6 mx-auto"
