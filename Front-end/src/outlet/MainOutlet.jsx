        ...
        <>
            ...
            <footer class=" bg-gray-100  border-t-1 dark:bg-gray-900 ">
                <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 ml-24 mt-10">
                    ...
                    <div>
                        <img src={img} className="w-40  font-bold  text-5xl text-white" alt="" />

                    </div>
                </div>
                <div class="py-6 px-4   dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022  All Rights Reserved Gamezat Team.
                    </span>
